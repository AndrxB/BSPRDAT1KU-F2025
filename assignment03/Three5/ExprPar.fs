...
# 152 "assignment03/Three5/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            ...
            Microsoft.FSharp.Core.Operators.box
                (
                 ...
                 : 'gentype__startMain));
# 161 "assignment03/Three5/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            let _1 = parseState.GetInput(1) :?> 'gentype_Expr in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 25 "assignment03/Three5/ExprPar.fsy"
                                                               _1                
                   )
# 25 "assignment03/Three5/ExprPar.fsy"
                 : Absyn.expr));
# 172 "assignment03/Three5/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            let _1 = parseState.GetInput(1) :?> string in
            Microsoft.FSharp.Core.Operators.box
                (
                   (
# 29 "assignment03/Three5/ExprPar.fsy"
                                                               Var _1            
                   )
# 29 "assignment03/Three5/ExprPar.fsy"
                 : 'gentype_Expr));
# 183 "assignment03/Three5/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
...
# 30 "assignment03/Three5/ExprPar.fsy"
                 : 'gentype_Expr));
# 194 "assignment03/Three5/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
...
# 31 "assignment03/Three5/ExprPar.fsy"
                 : 'gentype_Expr));
# 205 "assignment03/Three5/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
...
# 32 "assignment03/Three5/ExprPar.fsy"
                 : 'gentype_Expr));
# 216 "assignment03/Three5/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
...
# 33 "assignment03/Three5/ExprPar.fsy"
                 : 'gentype_Expr));
# 229 "assignment03/Three5/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            let _1 = parseState.GetInput(1) :?> 'gentype_Expr in
...
# 34 "assignment03/Three5/ExprPar.fsy"
                 : 'gentype_Expr));
# 241 "assignment03/Three5/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            let _1 = parseState.GetInput(1) :?> 'gentype_Expr in
            let _3 = parseState.GetInput(3) :?> 'gentype_Expr in
            Microsoft.FSharp.Core.Operators.box
...
# 35 "assignment03/Three5/ExprPar.fsy"
                 : 'gentype_Expr));
# 253 "assignment03/Three5/ExprPar.fs"
        (fun (parseState : FSharp.Text.Parsing.IParseState) ->
            let _1 = parseState.GetInput(1) :?> 'gentype_Expr in
            let _3 = parseState.GetInput(3) :?> 'gentype_Expr in
            Microsoft.FSharp.Core.Operators.box
...
# 36 "assignment03/Three5/ExprPar.fsy"
                 : 'gentype_Expr));
|]
# 266 "assignment03/Three5/ExprPar.fs"
